...
These parameters are then automatically put into a PHP array named: $plug['webhook'][$this_plug]['params']

The webhook key is also available, in the auto-created variable: $plug['webhook'][$this_plug]['key']
