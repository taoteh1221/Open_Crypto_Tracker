...
///////////////////////////////////////////////////////////////////////////////
// Google 0auth
if ( $webhook_hash[0] == pt_nonce_digest('google-0auth', $webhook_key) ) {
...
///////////////////////////////////////////////////////////////////////////////
// Telegram
elseif ( $webhook_hash[0] == pt_nonce_digest('telegram', $webhook_key) ) {
...
///////////////////////////////////////////////////////////////////////////////
// Test only
elseif ( $webhook_hash[0] == pt_nonce_digest('test-only', $webhook_key) ) {

$test_params = array('api_key' => $api_key);
						
$test_data = @external_api_data('params', $test_params, 0, $base_url . 'api/market_conversion/eur/kraken-btc-usd,coinbase-dai-usdc,coinbase-eth-usd', 2);
...
//echo pt_nonce_digest('test-only', $webhook_key) . ' -- ';
