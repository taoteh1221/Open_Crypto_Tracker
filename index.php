...
?>
		...
		<div id='values' class='tabdiv'>
			...
			?>
			 &nbsp; &nbsp; &nbsp; <span style='color: <?=( stristr($alert_percent[1], '-') == false ? 'green' : '#ea6b1c' )?>; font-weight: bold;'><?=ucfirst($alert_percent[0])?> alerts enabled (<?=$alert_percent[1]?>% / <?=$alert_percent[2]?>)</span>
			<?php
			}
