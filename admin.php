...
// If logged in
elseif ( $oct_gen->admin_logged_in() ) {
...
<div class='full_width_wrapper align_center'>
	...
	<div id='admin_wrapper' class='align_center' style='margin: auto;'>
		...
		<ul class="nav nav-tabs-vertical align_center" id="admin_tabs" role="tablist">
		  ...
		  <li class="nav-item">
			<a class="nav-link admin_change_width" data-toggle="tab" data-width="fixed_max" href="#admin_charts_alerts" role="tab" aria-controls="admin_charts_alerts"><?=( $oct_conf['gen']['asset_charts_toggle'] == 'on' ? 'Charts and ' : 'Price ' )?>Alerts</a>
		  </li>
		  <li class="nav-item">
