...
echo " "
echo "v4.06.0 / v4.07.7 / v4.10.0 HAVE MAJOR OVERHAULS TO CONFIGURATION VARIABLE NAMES (FOR MODULARITY,"
echo "SEMANTICS, AND EASY-TO-UNDERSTAND NAMES). MIGRATE YOUR CUSTOM CONFIG SETTINGS TO THE #NEW# VARIABLE NAMES."
echo " "
