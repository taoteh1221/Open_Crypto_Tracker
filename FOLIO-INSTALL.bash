...
echo "v5.00.0 and higher of this app RESETS ALL ALERTS CACHES (A DIRECTORY STRUCTURE UPGRADE), "
echo "SO ANY ALERTS WILL BE RESET (INCLUDING PLUGINS). THE !FIRST! RUNTIMES AFTER UPGRADING"
echo "WILL AUTOMATICALLY PREFORM THE RESET (ALERTS WILL BE ACCURATE AFTERWARDS)."
echo " "
echo " "
...
echo " "
echo "!!!!!BE SURE TO SCROLL UP, TO SAVE #ALL THE PORTFOLIO APP USAGE DOCUMENTATION# PRINTED OUT ABOVE, BEFORE YOU SIGN OFF FROM THIS TERMINAL SESSION!!!!!"
echo " "
