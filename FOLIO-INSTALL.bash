...
echo " "
echo "v4.07.7 AND HIGHER HAVE A MAJOR OVERHAUL TO CONFIGURATION VARIABLE NAMES (FOR EASY-TO-UNDERSTAND NAMES),"
echo "MIGRATE YOUR CUSTOM CONFIG SETTINGS TO THE #NEW# VARIABLE NAMES."
echo " "
...
echo "#WHEN YOU FIRST RUN THIS APP#. IT'S RECOMMENDED TO DO THIS #IMMEDIATELY#,"
