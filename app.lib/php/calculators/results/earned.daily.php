...
?>				
				...
				<?php
				echo number_format(get_trade_data($calculation_form_data[6], $calculation_form_data[7])['last_trade'], 8) . ' BTC ($' . round(( round(get_trade_data($calculation_form_data[6], $calculation_form_data[7])['last_trade'], 8) * get_btc_usd($btc_exchange)['last_trade'] ), 8) . ' USD)';
				?>
