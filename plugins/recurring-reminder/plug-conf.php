...
$plug_conf[$this_plug]['reminders'] = array(
												...
												array(
													 ...
													 'message' => "Review whether you should re-balance your portfolio (have individual assets take up a different precentage of your portfolio's total " . strtoupper($oct_conf['gen']['btc_prim_currency_pairing']) . " value)." // Reminder message
													 ),
