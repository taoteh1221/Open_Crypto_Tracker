...
<link rel="stylesheet" href="<?=$ct['plug']->plug_dir(true)?>/plug-assets/style.css" type="text/css" />
                        ...
                        $all_debt = array();
                            ...
                            $val['apr'] = $ct['var']->strip_formatting($val['apr']);
                                ...
                                <div class="field-group row">
                          			...
                          			<label class='blue' for="amount_<?=$key?>">Debt Amount <?=$ct['opt_conf']['bitcoin_currency_markets'][ $ct['conf']['gen']['bitcoin_primary_currency_pair'] ]?></label>
    ...
    ?>
        ...
        Total Monthly Interest: <?=$ct['opt_conf']['bitcoin_currency_markets'][ $ct['conf']['gen']['bitcoin_primary_currency_pair'] ] . number_format($debt_monthly_interest_total, 2, '.', ',')?><br />
        Total Yearly Interest: <?=$ct['opt_conf']['bitcoin_currency_markets'][ $ct['conf']['gen']['bitcoin_primary_currency_pair'] ] . number_format($debt_yearly_interest_total, 2, '.', ',')?>
        </p>
	...
	<script type="text/template" id="accounts_labels">
      ...
      <div class="field-group row">
  			...
  			<div class="extra_margins col-lg-2">
  			<label class='blue' for="amount_{?}">Debt Amount <?=$ct['opt_conf']['bitcoin_currency_markets'][ $ct['conf']['gen']['bitcoin_primary_currency_pair'] ]?></label>
