...
// Application version
$app_version = '4.28.0';  // 2021/MARCH/12TH
...
// SET original app_config array AFTER plugins config, BEFORE secure cache files, and BEFORE dynamic app config management
