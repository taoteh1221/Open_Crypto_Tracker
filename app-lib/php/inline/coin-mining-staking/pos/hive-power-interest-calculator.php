...
<p class='green' style='font-weight: bold;'>1 HIVE = <?=$ct['var']->num_to_str($hive_mrkt)?> BTC (<?=$ct['conf']['currency']['bitcoin_currency_markets'][ $ct['conf']['gen']['bitcoin_primary_currency_pair'] ]?><?php echo $hive_val_raw; ?>)</p>
