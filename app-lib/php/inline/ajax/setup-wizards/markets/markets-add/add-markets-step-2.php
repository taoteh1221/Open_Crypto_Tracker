...
?>
	     ...
	     <ul>
          	...
          	<span class='bitcoin'>(example[s]: tBTCUSD for Bitfinex, ETHDAI for Binance, SOL-USD for Coinbase, star-atlas-dao [API ID] for CoinGecko, Bonk/zBTC for Jupiter Ag. <span class='red'>[see what cases to use at: <a class='red' href='https://jup.ag/swap/' target='_BLANK'>jup.ag/swap</a>]</span>)</span>
