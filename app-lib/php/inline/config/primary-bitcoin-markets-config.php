...
if ( isset($ct['opt_conf']['bitcoin_preferred_currency_markets'][ $ct['conf']['gen']['bitcoin_primary_currency_pair'] ]) ) {
$ct['opt_conf']['bitcoin_preferred_currency_markets'][ $ct['conf']['gen']['bitcoin_primary_currency_pair'] ] = $ct['conf']['gen']['bitcoin_primary_currency_exchange'];
}
