...
$cfg_debug_mode = $smtp_vars['cfg_debug_mode'];  // Open Crypto Portfolio Tracker debug mode setting
$cfg_strict_ssl = $smtp_vars['cfg_strict_ssl'];  // Open Crypto Portfolio Tracker strict SSL setting
$cfg_app_version = $smtp_vars['cfg_app_version']; // Open Crypto Portfolio Tracker version
