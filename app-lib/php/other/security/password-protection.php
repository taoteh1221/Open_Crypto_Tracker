...
$restore_default_htaccess = $oct_cache->save_file($base_dir . '/.htaccess', $oct_cache->htaccess_dir_defaults() ); 
}
...
if ( $htaccess_username != '' && $htaccess_password != '' ) {
	...
	if ( !preg_match("/Require valid-user/i", $htaccess_protection_check) || $refresh_cached_oct_conf == 1 ) {
		
	$password_protection_enabled = $oct_cache->htaccess_dir_protection();
