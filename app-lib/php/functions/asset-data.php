...
?>
				...
				<p><b>Block Reward:</b> <input type='text' value='<?=( $_POST['block_reward'] && $_POST[$calculation_form_data['symbol'].'_submitted'] == 1 ? $_POST['block_reward'] : $calculation_form_data['block_reward'] )?>' name='block_reward' /> (may be static from Power User Config, verify current block reward manually)</p>
...
// Globals
global $_POST, $base_dir, $btc_worth_array, $coin_stats_array, $td_color_zebra, $cap_data_force_usd, $theme_selected, $primary_currency_market_standalone, $app_config, $selected_btc_primary_currency_value, $alert_percent, $show_secondary_trade_value, $coingecko_api, $coinmarketcap_api;
...
$original_market = $selected_exchange;
  ...
  $coin_value_total_raw = number_to_string($asset_amount * $coin_value_raw);
