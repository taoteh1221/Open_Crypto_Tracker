...
global $app_config, $current_runtime_user, $possible_http_users, $http_runtime_user;
	...
	app_logging('other_error', 'No bytes of data received to write to file "' . $file . '" (aborting useless file write)');
		...
		app_logging('api_error', 'POSSIBLE api timeout issue for cache file "' . $file . '" (TRY INCREASING "api_timeout" IN THE DEVELOPER CONFIG SETTINGS in config.php)', 'api_timeout: '.$app_config['api_timeout'].' seconds;');
		}
