...
function set_admin_2fa(obj=false, submit=false) {
		...
		// If turning 2FA on, show next step
		else if ( obj && obj.value == "on" && admin_2fa_set ) {
          $(".show_2fa_verification").show(250, 'linear'); // 0.25 seconds
		}
		// We don't need to compare 2FA codes if we are disabling 2FA
		else if ( !obj && submit == true || obj && obj.value == "off" && admin_2fa_set ) {
