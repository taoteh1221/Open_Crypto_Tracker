     ...
     $(elm_id).show(250, 'linear',function(){ // show after 0.25 seconds
           ...
           $.ajax({
                  ...
                  error: function(data) {
                       ...
                       var more_info = 'Try lowering the search result limit for Jupiter Aggregator in: APIs => External APIs => Jupiter Aggregator Search Results Maximum, or just TRY AGAIN, NOW THAT THE ASSET SEARCH FEATURE HAS CACHED RECENT EXCHANGE DATA FOR 1 HOUR.';
                       }
