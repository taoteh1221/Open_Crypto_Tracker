...
$app_config['interface_login'] = ''; // Leave blank to disable. This format MUST be used: 'username||password'
...
// Can be 0 to disable resetting (until the next price alert triggers an automatic reset)
$app_config['price_alerts_reset'] = 0; // (default = 0, [disabled] only resets after every new price alert)
////
