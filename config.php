...
$app_config['power_user']['defi_pools_info_cache_time'] = 20; // (default = 20)
////
...
$app_config['power_user']['defi_pools_max_per_platform'] = 120; // (default = 120)
////
