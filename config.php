...
// Currencies => symbols for BITCOIN/FIAT(OR STABLECOIN) pairings in our $coins_list array
// that we activate as fiat currency options (globally) throughout the app
