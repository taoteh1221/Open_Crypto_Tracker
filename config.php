...
// IF SMTP EMAIL SENDING --NOT-- USED, FROM email should be REAL address on the server domain, or risk having email sent to junk folder
...
// IF USING ADD-WIN10-SCHEDULER-JOB.bat INSTEAD (IN MAIN INSTALL FOLDER) ON WINDOWS 10,
// THEN #THIS SETTING SHOULD BE DISABLED# TO AVOID RUNNING 2 INSTANCES AT THE SAME TIME!
...
$ct_conf['power']['lite_chart_data_points_max'] = 500; // (default = 500), ADJUST WITH CARE!!!
...
// (#TO HELP PREVENT RUNTIME CRASHES# ON LOW POWER DEVICES OR HIGH TRAFFIC INSTALLS, WITH A LOW NUMBER OF 20 OR LESS)
...
$ct_conf['assets'] = array(
                    ...
                    'ACUSD' => array(
                        ...
                        'pair' => array(
                                    ...
                                    'usd' => array(
                                        'generic_usd' => 'wrapped-cusd-allbridge-from-celo',
                                                    ),
