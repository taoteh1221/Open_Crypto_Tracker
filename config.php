...
$pt_conf['comms']['comms_pause'] = 'off'; // 'on' / 'off' (Default = 'off' [comms are sent out normally])
...
$pt_conf['comms']['upgrade_alert'] = 'all'; // 'off' (disabled) / 'all' / 'ui' (web interface) / 'email' / 'text' / 'notifyme' / 'telegram'
////
// Wait X days between upgrade reminders
$pt_conf['comms']['upgrade_alert_reminder'] = 7; // (only used if upgrade check is enabled above)
...
$pt_conf['comms']['from_email'] = ''; // #SHOULD BE SET# to avoid email going to spam / junk
////
$pt_conf['comms']['to_email'] = ''; // #MUST BE SET# for price alerts and other email features
...
$pt_conf['comms']['smtp_login'] = ''; //  CAN BE BLANK. This format MUST be used: 'username||password'
////
...
$pt_conf['comms']['smtp_server'] = ''; // CAN BE BLANK. This format MUST be used: 'domain_or_ip:port_number' 
...
// IN THE EMAIL-TO-MOBILE-TEXT CONFIG SECTION (the "network name keys" in the $pt_conf['mob_net_txt_gateways'] variables array)
...
$pt_conf['comms']['telegram_your_username'] = ''; // Your telegram username (REQUIRED, setup in telegram app settings)
////
$pt_conf['comms']['telegram_bot_username'] = '';  // Your bot's username
////
$pt_conf['comms']['telegram_bot_name'] = ''; // Your bot's human-readable name (example: 'My Alerts Bot')
////
$pt_conf['comms']['telegram_bot_token'] = '';  // Your bot's access token
...
$pt_conf['comms']['price_alert_thres'] = 9.25; // CAN BE 0 TO DISABLE PRICE ALERTS
////
...
$pt_conf['comms']['price_alert_freq_max'] = 2; // Can be 0, to have no limits
////
...
$pt_conf['comms']['price_alert_block_vol_error'] = 'on'; // 'on' / 'off' 
////
...
$pt_conf['comms']['price_alert_min_vol'] = 3500;


// Alerts for failed proxy data connections (#ONLY USED# IF proxies are enabled further down in PROXY CONFIGURATION). 
// Choosing 'all' will send to all properly-configured communication channels, and automatically skip any not properly setup
$pt_conf['comms']['proxy_alert'] = 'email'; // 'off' (disabled) / 'all' / 'email' / 'text' / 'notifyme' / 'telegram'
////
$pt_conf['comms']['proxy_alert_freq_max'] = 1; // Re-allow same proxy alert(s) after X hours (per ip/port pair, can be 0)
////
$pt_conf['comms']['proxy_alert_runtime'] = 'cron'; // Which runtime mode should allow proxy alerts? Options: 'cron', 'ui', 'all' 
////
// 'include' or 'ignore' proxy alerts, if proxy checkup went OK? (after flagged, started working again when checked)
$pt_conf['comms']['proxy_alert_checkup_ok'] = 'include'; 
...
// Default marketcap data source: 'coingecko', or 'coinmarketcap' (COINMARKETCAP REQUIRES A #FREE# API KEY, see $pt_conf['gen']['cmc_key'] above)
$pt_conf['gen']['prim_mcap_site'] = 'coingecko'; 
...
$pt_conf['gen']['loc_time_offset'] = -4; // example: -5 or 5, -5.5 or 5.75 (#CAN BE DECIMAL# TO SUPPORT 30 / 45 MINUTE TIME ZONES)
...
$pt_conf['gen']['default_theme'] = 'dark'; // 'dark' or 'light'
...
$pt_conf['gen']['asset_charts_toggle'] = 'on'; // 'on' / 'off'
...
$pt_conf['proxy']['proxy_login'] = ''; // Use format: 'username||password'
////
...
$pt_conf['proxy']['proxy_list'] = array(
...
// Only used if $pt_conf['charts_alerts']['tracked_markets'] is filled in properly below, AND a cron job is setup (see README.txt for cron job setup information) 
////
...
$pt_conf['charts_alerts']['tracked_markets'] = array(
...
// END $pt_conf['charts_alerts']['tracked_markets']
...
$pt_conf['power']['activate_plugins'] = array(
...
$pt_conf['power']['remote_api_timeout'] = 35; // (default = 35)
...
$pt_conf['power']['admin_cookie_expire'] = 6; // (default = 6)
...
$pt_conf['power']['mcap_ranks_max'] = 300; // (default = 300)


// Maximum margin leverage available in the user interface ('Update' page, etc)
$pt_conf['power']['margin_leverage_max'] = 150; 
...
$pt_conf['power']['lite_chart_day_intervals'] = array(10, 30, 90, 180, 365, 730, 1460); // (default = 10, 30, 90, 180, 365, 730, 1460)
////
...
$pt_conf['power']['lite_chart_data_points_max'] = 400; // (default = 400), ADJUST WITH CARE!!!
...
// KEEP THIS NUMBER AS LOW AS IS FEASIBLE, TO SAVE ON CHART DATA STORAGE SPACE / MAINTAIN QUICK CHART LOAD TIMES
$pt_conf['power']['chart_crypto_vol_dec'] = 4;  // (default = 4)
////
...
$pt_conf['power']['charts_backup_freq'] = 1; 
...
$pt_conf['power']['asset_performance_chart_defaults'] = '600||14'; // 'chart_height||menu_size' (default = '600||14')
...
// CHART HEIGHT MIN/MAX = 400/900 (increments of 100), MENU SIZE MIN/MAX (increments of 1) = 7/16
$pt_conf['power']['asset_mcap_chart_defaults'] = '600||14'; // 'chart_height||menu_size' (default = '600||14')
...
$pt_conf['power']['system_stats_first_chart_highest_val'] = 1; // (default = 1) 
////
...
$pt_conf['power']['system_stats_second_chart_max_scale'] = 150; // (default = 150) 
...
$pt_conf['power']['defi_pools_info_cache_time'] = 25; // (default = 25)
////
...
$pt_conf['power']['defi_liquidity_pools_max'] = 1000; // (default = 1000)
////
// Sort DeFi pools by USD liquidity or volume (largest first)
$pt_conf['power']['defi_liquidity_pools_sort_by'] = 'volume'; // 'volume' or 'liquidity' (default = 'volume')
////
...
$pt_conf['power']['defi_pools_max_trades'] = 60; // (default = 60)
...
$pt_conf['power']['captcha_text_contrast'] = -5; // example: -5 or 5 (default = -5)
////
// MAX OFF-ANGLE DEGREES (tilted backward / forward) of CAPTCHA IMAGE text characters (MAXIMUM OF 35)
$pt_conf['power']['captcha_text_angle'] = 30; // (default = 30)


// Days until old backup archives should be deleted (chart data archives, etc)
$pt_conf['power']['backup_arch_del_old'] = 7; 

																					
// ASSET MARKETS chart colors (https://www.w3schools.com/colors/colors_picker.asp)
////
// Charts border color
$pt_conf['power']['charts_border'] = '#808080'; // (default: '#808080')
////
// Charts background color
$pt_conf['power']['charts_background'] = '#515050';   // (default: '#515050')
////
// Charts line color
$pt_conf['power']['charts_line'] = '#444444';   // (default: '#444444')
////
// Charts text color
$pt_conf['power']['charts_text'] = '#e8e8e8';   // (default: '#e8e8e8')
////
// Charts link color
$pt_conf['power']['charts_link'] = '#939393';   // (default: '#939393')
////
// Charts price (base) gradient color
$pt_conf['power']['charts_price_gradient'] = '#000000';  // (default: '#000000')
////
// Charts tooltip background color
$pt_conf['power']['charts_tooltip_background'] = '#bbbbbb'; // (default: '#bbbbbb')
////
// Charts tooltip text color
$pt_conf['power']['charts_tooltip_text'] = '#222222'; // (default: '#222222')
...
// EACH ALTCOIN LISTED HERE MUST EXIST IN $pt_conf['power']['crypto_pairing'] ABOVE,
// AND !MUST HAVE! AN EXISTING 'btc' MARKET (within 'pairing') in it's 
// $pt_conf['assets'] listing (further down in this config file),
...
$pt_conf['power']['eth_erc20_icos'] = array(
...
$pt_conf['power']['hive_powerdown_time'] = 13; 
////
...
$pt_conf['power']['hivepower_yearly_interest'] = 1.2;
...
$pt_conf['power']['mining_calculators'] = array(
...
$pt_conf['power']['news_feed_entries_show'] = 5; // (default = 5)
////
// RSS feed entries under X days old are marked as 'new'
$pt_conf['power']['news_feed_entries_new'] = 2; // (default = 2)
////
// RSS news feeds available on the News page
$pt_conf['power']['news_feed'] = array(
...
$pt_conf['dev']['log_verb'] = 'normal'; // 'normal' / 'verbose'
...
$pt_conf['dev']['smtp_strict_ssl'] = 'off'; // (DEFAULT IS 'off', TO ASSURE SMTP EMAIL SENDING STILL WORKS THROUGH MISCONFIGURED SMTP SERVERS)
...
$pt_conf['dev']['remote_api_strict_ssl'] = 'off'; // (default = 'off')
...
$pt_conf['dev']['coingecko_api_batched_max'] = 100; // (default = 100), ADJUST WITH CARE!!!
...
$pt_conf['dev']['news_feed_batched_max'] = 25; // (default = 25), ADJUST WITH CARE!!!
////
...
$pt_conf['dev']['news_feed_cache_min_max'] = '90,180'; // 'min,max' (default = '90,180'), ADJUST WITH CARE!!!
...
$pt_conf['dev']['all_chart_rebuild_min_max'] = '4,12'; // 'min,max' (default = '4,12'), ADJUST WITH CARE!!!
			
			
// Configuration for advanced CAPTCHA image settings on all admin login / reset pages
$pt_conf['dev']['captcha_image_width'] = 430; // Image width (default = 430)
////
$pt_conf['dev']['captcha_image_height'] = 130; // Image height (default = 130)
////
$pt_conf['dev']['captcha_text_margin'] = 4; // MINIMUM margin of text from edge of image (approximate / average) (default = 4)
////
$pt_conf['dev']['captcha_text_size'] = 50; // Text size (default = 50)
////
$pt_conf['dev']['captcha_chars_length'] = 6; // Number of characters in captcha image (default = 6)
////
// ONLY MOST READABLE characters allowed for use in captcha image 
$pt_conf['dev']['captcha_permitted_chars'] = 'ACEFHMNPQRSTUVWXYZ2345679'; // (default = 'ACEFHMNPQRSTUVWXYZ2345679')
...
$pt_conf['dev']['override_user_agent'] = ''; 


// Default charset used
$pt_conf['dev']['charset_default'] = 'UTF-8'; 
////
...
$pt_conf['dev']['charset_unicode'] = 'UTF-16'; 
...
$pt_conf['dev']['chmod_cache_dir'] = '0777'; // (default = '0777')
////
// Cache files permissions
$pt_conf['dev']['chmod_cache_file'] = '0666'; // (default = '0666')
////
// .htaccess / index.php index security files permissions
$pt_conf['dev']['chmod_index_sec'] = '0664'; // (default = '0664')
...
// (ALL execution times are automatically 600 IN DEBUG MODE)
$pt_conf['dev']['cron_max_exec_time'] = 600; // (default = 600)
////
...
// (ALL execution times are automatically 600 IN DEBUG MODE)
$pt_conf['dev']['int_api_max_exec_time'] = 90; // (default = 90)
////
...
// (ALL execution times are automatically 600 IN DEBUG MODE)
$pt_conf['dev']['webhook_max_exec_time'] = 90; // (default = 90)
...
// !MUST BE LOWERCASE!
$pt_conf['dev']['limited_apis'] = array(
						'bit2c.co.il',
						'bitforex.com',
						'bitflyer.com',
						'bitmex.com',
...
// TLD-extensions-only mapping (Top Level Domain extensions only, supported in the $pt_gen->get_tld_or_ip() function, which removes subdomains for tld checks)
// IF YOU ADD A NEW API, !MAKE SURE IT'S DOMAIN EXTENSION EXISTS HERE!
// (NO LEADING DOTS, !MUST BE LOWERCASE!)
$pt_conf['dev']['top_level_domain_map'] = array(
					'co',
					'co.il',
					'co.uk',
					'com', 
...
add that EXACT name in this config file further above within the $pt_conf['comms']['to_mobile_text'] setting as the text network name variable,
...
$pt_conf['mob_net_txt_gateways'] = array(
