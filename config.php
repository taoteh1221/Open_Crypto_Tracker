...
$app_config['charts_alerts']['tracked_markets'] = array(
				...
				// 'othersymbol-4' => 'exchange4||trade_pairing4||alert',
					...
					'mkr-3' => 'coinbase||btc||chart',
					'mkr-4' => 'uniswap-v2||eth||both',
...
// TONS OF DATA, the higher number the better for fast page load times
$app_config['power_user']['defi_pools_info_cache_time'] = 30; // (default = 30)
////
// Maximum number of DeFi pools to fetch per platform (uniswap, uniswap-v2, balancer, curve, etc), POOLS ARE SORTED BY HIGHEST TRADE VOLUME
$app_config['power_user']['defi_pools_max_per_platform'] = 60; // (default = 60)
////
// Maximum number of trades to fetch per DeFi pool, TRADES ARE SORTED BY NEWEST FIRST
$app_config['power_user']['defi_pools_max_trades'] = 30; // (default = 30)
...
// TRY TO #NOT# ADD STABLECOINS HERE, ATTEMPT TO USE $app_config['power_user']['bitcoin_currency_markets'] INSTEAD (TO AUTO-CLIP UN-NEEDED DECIMAL POINTS)
                    ...
                    'DAI' => array(
                        ...
                        'market_pairing' => array(
                                    ...
                                    'usdc' => array(
                                    	 'coinbase' => 'DAI-USDC',
                                        'hitbtc' => 'DAIUSDC',
                                    	 'curve_iearn' => 'yDAI_USDC-DAI',
                                    	 'curve_compound' => 'cDAI_USDC-DAI',
                                                    ),
