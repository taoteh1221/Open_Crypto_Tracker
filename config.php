...
$app_config['comms']['price_alerts_freq_max'] = 2; // Can be 0, to have no limits
////
...
$app_config['power_user']['admin_cookie_expire'] = 6; // (default = 6)
...
$app_config['power_user']['lite_chart_day_intervals'] = array(10, 30, 90, 180, 365, 730, 1460); // (default = 10, 30, 90, 180, 365, 730, 1460)
////
...
$app_config['power_user']['asset_performance_chart_defaults'] = '600||14'; // 'chart_height||menu_size' (default = '600||14')
...
// CHART HEIGHT MIN/MAX = 400/900 (increments of 100), MENU SIZE MIN/MAX (increments of 1) = 7/16
$app_config['power_user']['asset_marketcap_chart_defaults'] = '600||14'; // 'chart_height||menu_size' (default = '600||14')
...
$app_config['portfolio_assets'] = array(
                    ...
                    'LRC' => array(
                        ...
                        'asset_name' => 'Loopring',
                        'marketcap_website_slug' => 'loopring',
                        'market_pairing' => array(
