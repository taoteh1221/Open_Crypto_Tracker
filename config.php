...
////
// Refresh cached comparison asset prices every X days (since last price refresh / alert) with the current latest spot prices
// Can be 0 to disable refreshing (until the next price alert triggers an automatic refresh)
$app_config['price_alerts_refresh'] = 0; // (default = 0, [disabled] only refreshes after every new price alert)
////
...
// Maximum execution time for interface in seconds (how long it's allowed to run before automatically killing the process)
$app_config['ui_max_execution_time'] = 100; // (default = 100)


// Maximum execution time for cron jobs in seconds (how long it's allowed to run before automatically killing the process)
