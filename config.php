...
$ct_conf['comms']['price_alert_thres'] = 9.45; // CAN BE 0 TO DISABLE PRICE ALERTS
////
...
$ct_conf['power']['asset_performance_chart_defaults'] = '700||10'; // 'chart_height||menu_size' (default = '700||10')
