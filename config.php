...
// SEE THE $ct_conf['power']['limited_apis'] SETTING FURTHER DOWN IN THE DEVELOPER SECTION, FOR EXCHANGES !NOT RECOMMENDED FOR USAGE HERE!
...
$ct_conf['other_api']['alphavantage_per_day_limit'] = 100; // (default = 100 [FOR FREE SERVICE])
...
// DEVELOPER-RELATED, !CHANGE WITH #EXTREME# CARE, OR YOU CAN BREAK THE APP!
...
$ct_conf['power']['all_chart_rebuild_min_max'] = '4,8'; // 'min,max' (default = '4,8'), ADJUST WITH CARE!!!
////
...
$ct_conf['power']['charset_default'] = 'UTF-8'; 
////
...
$ct_conf['power']['charset_unicode'] = 'UTF-16'; 
...
$ct_conf['power']['cron_max_exec_time'] = 1320; // (default = 1320)
////
...
$ct_conf['power']['int_api_max_exec_time'] = 120; // (default = 120)
////
...
$ct_conf['power']['webhook_max_exec_time'] = 120; // (default = 120)
...
$ct_conf['power']['tracked_throttle_limited_servers'] = array(
                                      					'alphavantage.co',
                                      				    );
...
$ct_conf['power']['limited_apis'] = array(
                						'alphavantage.co',
                						'bitforex.com',
                						'bitflyer.com',
                						'bitmex.com',
