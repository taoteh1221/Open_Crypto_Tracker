...
// This time will automatically vary randomly up to 35 minutes EXTRA, to avoid all feeds updating at the same time (which slows page loads significantly)
$app_config['power_user']['rss_feed_cache_time'] = 70; 
