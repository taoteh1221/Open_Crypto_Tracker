...
$app_config['power_user']['lite_chart_day_intervals'] = array(7, 30, 180, 365, 730, 1460); // (default = 7, 30, 180, 365, 730, 1460)
...
$app_config['power_user']['news_feeds_cache_min_max'] = '120,240'; // 'min,max' (default = '120,240')
////
