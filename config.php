...
$app_config['price_alerts_threshold'] = 8.85; // CAN BE 0 TO DISABLE PRICE ALERTS
////
...
$app_config['price_alerts_min_volume'] = 14000;
...
$app_config['interface_login'] = ''; // Leave blank to disable requiring an interface login. This format MUST be used: 'username||password'


// API key for etherscan.io (required unfortunately, but a FREE level is available): https://etherscan.io/apis
$app_config['etherscanio_api_key'] = '';
...
////
// Backup chart data in a zip file in the 'backups' subdirectory (with a secure random suffix for privacy), only used if $app_config['charts_page'] (IN GENERAL SETTINGS) is on
...
$app_config['price_alerts_fixed_reset'] = 0; // (default = 0)
////
...
$app_config['remote_api_strict_ssl'] = 'on'; // (default = 'on')
...
$app_config['remote_api_timeout'] = 20; // (default = 20)
...
$app_config['local_api_rate_limit'] = 10; // (default = 10)


// Local / internal API market limit (maximum number of markets requested per call)
$app_config['local_api_market_limit'] = 20; // (default = 20)
...
$app_config['chainstats_cache_time'] = 70; // Minutes to cache blockchain stats (for mining calculators). Set high initially, it can be strict


$app_config['marketcap_cache_time'] = 40; // Minutes to cache marketcap rankings...start high and test lower, it can be strict
...
$app_config['marketcap_ranks_max'] = 250; 
...
$app_config['hive_powerdown_time'] = 13; 
////
...
$app_config['hivepower_yearly_interest'] = 1.2;
...
$app_config['ui_max_execution_time'] = 100; // (default = 100)
...
// (ALL execution times are automatically 350 IN DEBUG MODE)
$app_config['cron_max_execution_time'] = 300; // (default = 300)
