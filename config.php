...
$ocpt_conf = array(); // REQUIRED, DON'T DELETE BY ACCIDENT
...
$ocpt_conf['comms']['from_email'] = ''; // #SHOULD BE SET# to avoid email going to spam / junk
////
$ocpt_conf['comms']['to_email'] = ''; // #MUST BE SET# for price alerts and other email features
...
$ocpt_conf['comms']['smtp_login'] = ''; //  CAN BE BLANK. This format MUST be used: 'username||password'
////
...
$ocpt_conf['comms']['smtp_server'] = ''; // CAN BE BLANK. This format MUST be used: 'domain_or_ip:port_number' 
...
// IN THE EMAIL-TO-MOBILE-TEXT CONFIG SECTION (the "network name keys" in the $ocpt_conf['mob_net_txt_gateways'] variables array)
...
$ocpt_conf['comms']['to_mobile_text'] = '';
...
$ocpt_conf['comms']['textbelt_apikey'] = '';


// CAN BE BLANK. For asset price alert textlocal notifications. Setup: https://www.textlocal.com/integrations/api/
$ocpt_conf['comms']['textlocal_account'] = ''; // This format MUST be used: 'username||hash_code'
...
$ocpt_conf['comms']['notifyme_accesscode'] = '';
...
$ocpt_conf['comms']['google_application_name'] = '';
////
$ocpt_conf['comms']['google_client_id'] = '';
////
$ocpt_conf['comms']['google_client_secret'] = '';
...
$ocpt_conf['comms']['telegram_your_username'] = ''; // Your telegram username (REQUIRED, setup in telegram app settings)
////
$ocpt_conf['comms']['telegram_bot_username'] = '';  // Your bot's username
////
$ocpt_conf['comms']['telegram_bot_name'] = ''; // Your bot's human-readable name (example: 'My Alerts Bot')
////
$ocpt_conf['comms']['telegram_bot_token'] = '';  // Your bot's access token
...
$ocpt_conf['comms']['price_alert_thres'] = 9.25; // CAN BE 0 TO DISABLE PRICE ALERTS
////
...
$ocpt_conf['comms']['price_alert_freq_max'] = 2; // Can be 0, to have no limits
////
...
$ocpt_conf['comms']['price_alert_block_vol_error'] = 'on'; // 'on' / 'off' 
////
...
$ocpt_conf['comms']['price_alert_min_vol'] = 3500;


// Alerts for failed proxy data connections (#ONLY USED# IF proxies are enabled further down in PROXY CONFIGURATION). 
// Choosing 'all' will send to all properly-configured communication channels, and automatically skip any not properly setup
$ocpt_conf['comms']['proxy_alert'] = 'email'; // 'off' (disabled) / 'all' / 'email' / 'text' / 'notifyme' / 'telegram'
////
$ocpt_conf['comms']['proxy_alert_freq_max'] = 1; // Re-allow same proxy alert(s) after X hours (per ip/port pair, can be 0)
////
$ocpt_conf['comms']['proxy_alert_runtime'] = 'cron'; // Which runtime mode should allow proxy alerts? Options: 'cron', 'ui', 'all' 
////
// 'include' or 'ignore' proxy alerts, if proxy checkup went OK? (after flagged, started working again when checked)
$ocpt_conf['comms']['proxy_alert_checkup_ok'] = 'include'; 
...
$ocpt_conf['proxy']['proxy_login'] = ''; // Use format: 'username||password'
////
...
$ocpt_conf['proxy']['proxy_list'] = array(
...
// Only used if $ocpt_conf['charts_alerts']['tracked_markets'] is filled in properly below, AND a cron job is setup (see README.txt for cron job setup information) 
////
...
$ocpt_conf['charts_alerts']['tracked_markets'] = array(
...
// END $ocpt_conf['charts_alerts']['tracked_markets']
...
// 'ext_api_live_telemetry' (external API requests from server),
// 'ext_api_cache_telemetry' (external API requests from cache),
...
add that EXACT name in this config file further above within the $ocpt_conf['comms']['to_mobile_text'] setting as the text network name variable,
...
$ocpt_conf['mob_net_txt_gateways'] = array(
