...
// default [primary currency] price / crypto price / volume data for charts of all assets added to $app_config['charts_alerts']['markets'] (further down in CHART AND PRICE ALERT CONFIGURATION)
...
// Shows system statistics in the interface FOR LOGGED-IN ADMIN, if stats are available (system load, system temperature, free disk space, free system memory, visitor stats, etc)
...
// Only used if $app_config['charts_alerts']['markets'] is filled in properly below, AND a cron job is setup (see README.txt for cron job setup information) 
////
...
$app_config['charts_alerts']['markets'] = array(
...
// END $app_config['charts_alerts']['markets']
...
$app_config['power_user']['secondary_crypto_pairing'] = array(
...
// EACH ALTCOIN LISTED HERE MUST EXIST IN $app_config['power_user']['secondary_crypto_pairing'] ABOVE,
...
$app_config['power_user']['secondary_crypto_pairing_preferred_markets'] = array(
