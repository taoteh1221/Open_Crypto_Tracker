...
$app_config['power_user']['activate_cron_plugins'] = array(
						...
						//'decred-proposals',  // Decred Proposals plugin (sends alerts whenever there is a new Decred proposal up for discussion / vote)
							);
...
$app_config['power_user']['defi_pools_max_per_platform'] = 100; // (default = 100)
////
