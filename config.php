...
$ct_conf['power']['system_temp_warning'] = 80; // Temp IN CELCIUS! (default = 80)
////
$ct_conf['power']['memory_used_percent_warning'] = 90; // DO #NOT# INCLUDE PERCENT SYMBOL! (default = 90)
////
$ct_conf['power']['free_partition_space_warning'] = 500; // Scale IN MEGABYTES! (default = 500)
////
$ct_conf['power']['portfolio_cache_warning'] = 10000; // Scale IN MEGABYTES! (default = 10000)
