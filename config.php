...
////
// Reset cached comparison asset prices every X days (since last price reset / alert) with the current latest spot prices
// Can be 0 to disable fixed interval resetting (IN WHICH CASE IT WILL STILL RESET, BUT ONLY when the next price alert triggers an automatic reset)
$app_config['price_alerts_reset'] = 0; // (default = 0)
////
