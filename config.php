...
$app_config['comms']['smtp_email_login'] = ''; //  CAN BE BLANK. This format MUST be used: 'username||password'
////
// Examples: 'example.com:25' (non-encrypted), 'example.com:465' (ssl-encrypted), 'example.com:587' (tls-encrypted)
$app_config['comms']['smtp_email_server'] = ''; // CAN BE BLANK. This format MUST be used: 'domain_or_ip:port_number' 
////
// MAKE SURE PORT NUMBER ABOVE CORRESPONDS
$app_config['comms']['smtp_email_secure'] = 'tls'; // CAN BE 'off' FOR NO SECURE CONNECTION, or 'tls', or 'ssl' for secure connections. 
...
$app_config['comms']['google_home_application_name'] = '';
////
$app_config['comms']['google_home_client_id'] = '';
////
$app_config['comms']['google_home_client_secret'] = '';
...
// Alerts for failed proxy data connections (if proxies are enabled further down in PROXY SETTINGS). 
// Choosing 'all' will send to all properly-configured communication channels, and automatically skip any not properly setup
...
// Caches the default [primary currency] ($app_config['general']['btc_primary_currency_pairing'] further down in GENERAL SETTINGS)
// default [primary currency] price / crypto price / volume data for charts of all assets added to $app_config['charts_price_alerts']['markets'] (further down in CHART AND PRICE ALERT SETTINGS)
...
////
// Charts border color
$app_config['charts_price_alerts']['charts_border'] = '#808080';  
////
// Charts background color
$app_config['charts_price_alerts']['charts_background'] = '#515050';  
////
// Charts line color
$app_config['charts_price_alerts']['charts_line'] = '#444444';  
////
// Charts text color
$app_config['charts_price_alerts']['charts_text'] = '#dddddd';  
////
// Charts link color
$app_config['charts_price_alerts']['charts_link'] = '#b5b5b5';  
////
// Charts price (base) gradient color
$app_config['charts_price_alerts']['charts_price_gradient'] = '#000000'; 
////
// Charts tooltip background color
$app_config['charts_price_alerts']['charts_tooltip_background'] = '#bbbbbb';
////
// Charts tooltip text color
$app_config['charts_price_alerts']['charts_tooltip_text'] = '#222222';
////
// Backup chart data in a zip file in the 'backups' subdirectory (with a secure random suffix for privacy), only used if $app_config['general']['charts_toggle'] (IN GENERAL SETTINGS) is on
$app_config['charts_price_alerts']['charts_backup_freq'] = 1; // Every X days backup chart data. 0 disables backups. Email to / from !MUST BE SET! (a download link is emailed to you of the chart data archive)


// Asset price alert settings
// Only used if $app_config['charts_price_alerts']['markets'] is filled in properly below, AND a cron job is setup (see README.txt for cron job setup information) 
////
...
$app_config['charts_price_alerts']['price_alerts_fixed_reset'] = 0; // (default = 0)
////
...
$app_config['charts_price_alerts']['price_alerts_whale_alert_threshold'] = '1.65||8.85||9.1||16000';
...
$app_config['charts_price_alerts']['markets'] = array(
				...
				// 'othersymbol-3' => 'exchange3||trade_pairing3||chart',
					...
					'btc-17' => 'tidebit||hkd||chart',
					'btc-18' => 'localbitcoins||chf||chart',
					'btc-19' => 'upbit||krw||chart',
					'btc-20' => 'bitso||mxn||chart',
					'btc-21' => 'localbitcoins||nzd||chart',
					'btc-22' => 'localbitcoins||rub||chart',
					'btc-23' => 'lakebtc||sgd||chart',
...
// END $app_config['charts_price_alerts']['markets']
...
$app_config['power_user']['remote_api_timeout'] = 20; // (default = 20)
...
$app_config['power_user']['local_api_rate_limit'] = 10; // (default = 10)
...
$app_config['power_user']['crypto_to_crypto_pairing'] = array(
...
// EACH ALTCOIN LISTED HERE MUST EXIST IN $app_config['power_user']['crypto_to_crypto_pairing'] ABOVE,
...
$app_config['power_user']['preferred_altcoin_markets'] = array(
...
// Settings for the CAPTCHA image on all admin login / reset pages
$app_config['power_user']['captcha_permitted_chars'] = 'ACEFMNPRXY3478'; // Characters allowed for use in captcha image
////
...
$app_config['developer']['log_detail_level'] = 'normal'; // 'normal' / 'verbose'
////
...
// (ALL execution times are automatically 350 IN DEBUG MODE)
$app_config['developer']['cron_max_execution_time'] = 300; // (default = 300)
...
$app_config['developer']['override_default_user_agent'] = ''; 
...
$app_config['developer']['chmod_permission_cache_directories'] = '0777'; // (default = '0777')
////
// Cache files permissions
$app_config['developer']['chmod_permission_cache_files'] = '0666'; // (default = '0666')
////
// .htaccess / index.php index security files permissions
$app_config['developer']['chmod_permission_index_security'] = '0664'; // (default = '0664')
