...
$app_config['power_user']['lite_chart_day_intervals'] = array(5, 10, 30, 180, 365, 730); // (default = 5, 10, 30, 180, 365, 730)
...
// (#PREVENTS RUNTIME CRASHES# ON LOW POWER DEVICES, WITH A LOWER NUMBER)
