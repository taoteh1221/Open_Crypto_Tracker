...
$header_link = "<a class='bitcoin' href='admin.php?iframe_nonce=" . $ct['sec']->admin_nonce('iframe_' . $this_plug) . "&plugin=" . $this_plug . "'>" . $plug['conf'][$this_plug]['ui_name'] . "</a> -> Documentation";
}
else {
...
?>
        ...
        <h3 style='padding-bottom: 10px;' class='bitcoin align_center'><a class='bitcoin custom-unstyle-dropdown-item' href='admin.php?iframe_nonce=<?=$ct['sec']->admin_nonce('iframe_plugins')?>&section=plugins'>Plugins</a>: <?=$header_link?></h3>
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////
             ...
             ?>
     	   <p><a style='font-weight: bold; font-size: 20px;' href='admin.php?iframe_nonce=<?=$ct['sec']->admin_nonce('iframe_' . $this_plug)?>&plugin=<?=$this_plug?>&plugin_docs=1'>Plugin Usage / Documentation</a></p>
             <?php
             }
