...
$ct['admin_render_settings']['backup_archive_frequency']['is_range'] = true;

$ct['admin_render_settings']['backup_archive_frequency']['range_ui_meta_data'] .= 'zero_is_disabled;';

$ct['admin_render_settings']['backup_archive_frequency']['range_min'] = 0;

$ct['admin_render_settings']['backup_archive_frequency']['range_max'] = 7;

$ct['admin_render_settings']['backup_archive_frequency']['range_step'] = 1;

$ct['admin_render_settings']['backup_archive_frequency']['range_ui_prefix'] = 'Every ';
