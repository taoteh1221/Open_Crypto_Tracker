...
?>
	...
	<form name='toggle_admin_security' id='toggle_admin_security' action='admin.php?iframe_nonce=<?=$ct['sec']->admin_nonce('iframe_security')?>&section=security&refresh=all' method='post'>
	
	<input type='hidden' name='admin_nonce' value='<?=$ct['sec']->admin_nonce('toggle_admin_security')?>' />
	...
	<form name='toggle_admin_2fa' id='toggle_admin_2fa' action='admin.php?iframe_nonce=<?=$ct['sec']->admin_nonce('iframe_security')?>&section=security&refresh=all' method='post'>
	
	<input type='hidden' name='admin_nonce' value='<?=$ct['sec']->admin_nonce('toggle_admin_2fa')?>' />
	...
	<br /> <input type='radio' name='opt_admin_2fa' id='opt_admin_2fa_off' value='off' onclick='set_admin_2fa(this);' <?=( $ct['admin_area_2fa'] == 'off' && !$force_show_2fa_setup || $force_show_2fa_setup == 'off' ? 'checked' : '' )?> /> Off &nbsp; <input type='radio' name='opt_admin_2fa' id='opt_admin_2fa_on' value='on' onclick='set_admin_2fa(this);' <?=( $ct['admin_area_2fa'] == 'on' || $force_show_2fa_setup == 'on' ? 'checked' : '' )?> /> On &nbsp; <input type='radio' name='opt_admin_2fa' id='opt_admin_2fa_scrict' value='strict' onclick='set_admin_2fa(this);' <?=( $ct['admin_area_2fa'] == 'strict' || $force_show_2fa_setup == 'strict' ? 'checked' : '' )?> /> Strict
	 ...
	 <p><img class='qr_code' src='templates/interface/media/images/2fa_setup.php?2fa_setup_nonce=<?=$ct['sec']->admin_nonce('2fa_setup')?>' /></p>
