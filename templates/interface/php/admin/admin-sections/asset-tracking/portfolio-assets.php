...
<div id='update_markets_ajax' style='margin: 1em;'>
  ...
  <br clear='all' /><br clear='all' />
     	...
     	<p class='input_margins bitcoin_dotted'>
     	
		<b class='bitcoin'>NOTES ABOUT **STOCK MARKET** ASSETS:<br /><br />
		
		ALREADY-ADDED **AND** "ADD MARKETS" SEARCH RESULTS, THAT ARE **STOCK MARKET** ASSETS, ARE GIVEN A SUFFIX "STOCK", APPENDED TO THE STOCK TICKER VALUE, **TO FLAG THE ASSET AS A STOCK WITHIN THIS APP** (EG: IBM = IBMSTOCK).<br /><br />
		
		ADDITIONALLY, TICKER / PAIRING / COMPANY NAME IS AUTO-SET ***MORE RELIABLY***, WHEN YOU USE THE "All Exchanges" SEARCH MODE FOR STOCKS.</b>
