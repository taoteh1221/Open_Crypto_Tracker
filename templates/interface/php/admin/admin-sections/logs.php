...
<div class='full_width_wrapper'>
	    ...
	    <fieldset class='subsection_fieldset'><legend class='subsection_legend'> <strong>Error Logs</strong> </legend>
	        ...
	        &nbsp; <b>Last lines to show:</b> <input type='text' id='errors_log_lines' value='100' maxlength="4" size="5" />
	        
	        &nbsp; <span id='errors_log_alert' class='red'></span>
	        
	        </p>
	        
	        <pre class='logs'><code class='hide-x-scroll plaintext' style='width: 100%; height: 750px;' id='errors_log'></code></pre>
	...
	?>
	    <fieldset class='subsection_fieldset'><legend class='subsection_legend'> <strong>SMTP Error Logs</strong> </legend>
	        ...
	        &nbsp; <b>Last lines to show:</b> <input type='text' id='smtp_errors_log_lines' value='100' maxlength="4" size="5" />
	        
	        &nbsp; <span id='smtp_errors_log_alert' class='red'></span>
	        
	        </p>
	        
	        <pre class='logs'><code class='hide-x-scroll plaintext' style='width: 100%; height: 750px;' id='smtp_errors_log'></code></pre>
	...
	?>
	    <fieldset class='subsection_fieldset'><legend class='subsection_legend'> <strong>Debugging Logs</strong> </legend>
	        ...
	        &nbsp; <b>Last lines to show:</b> <input type='text' id='debugging_log_lines' value='100' maxlength="4" size="5" />
	        
	        &nbsp; <span id='debugging_log_alert' class='red'></span>
	        
	        </p>
	        
	        <pre class='logs'><code class='hide-x-scroll plaintext' style='width: 100%; height: 750px;' id='debugging_log'></code></pre>
