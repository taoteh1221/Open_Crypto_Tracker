...
var server_header_defaults_content = '<h5 class="yellow tooltip_title">Average Server Header Size Limits</h5>'
   ...
   <ul>
	...
	<span class='chart_loading' style='color: <?=( $ct['sel_opt']['theme_selected'] == 'light' ? 'black' : 'white' )?>;'> &nbsp; Loading chart #1 for system data...</span>
	...
	<span class='chart_loading' style='color: <?=( $ct['sel_opt']['theme_selected'] == 'light' ? 'black' : 'white' )?>;'> &nbsp; Loading chart #2 for system data...</span>
  ...
  <h3 class='bitcoin'>(<?=$ct['conf']['power']['access_stats_delete_old']?> Day Report)</h3>
   ...
   <ul>
	...
	<li class='bitcoin' style='font-weight: bold;'>Current UTC time: <span class='utc_timestamp red'></span></li>	
	   ...
	   <pre class='rounded' style='display: inline-block; padding-top: 1em !important;'><code class='hide-x-scroll less' style='white-space: nowrap; width: auto; display: inline-block;'>[UTC timestamp] runtime => category (type): details; [ (tracing if verbose logging enabled) ]</code></pre>
