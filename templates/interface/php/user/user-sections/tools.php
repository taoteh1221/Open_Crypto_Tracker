...
<div class='full_width_wrapper'>
	...
	<?=$ct['gen']->start_page_html('tools')?>
			...
			<fieldset class='subsection_fieldset'>
    			...
    			<p class='green' style='font-weight: bold;'>Per-Unit (<?=strtoupper($ct['conf']['currency']['bitcoin_primary_currency_pair'])?>): <?=$ct['opt_conf']['conversion_currency_symbols'][ $ct['conf']['currency']['bitcoin_primary_currency_pair'] ]?><span id='target_prim_currency'>0.00</span> (<span id='target_btc'>0.00</span> BTC) </p>
    			
    			<p class='green' style='font-weight: bold;'>Total: <?=$ct['opt_conf']['conversion_currency_symbols'][ $ct['conf']['currency']['bitcoin_primary_currency_pair'] ]?><span id='target_total_prim_currency'>0.00</span> (<span id='target_total_btc'>0.00</span> BTC) </p>
            ...
            $this_plug = $plugin_key;
            	...
            	if ( $plug['conf'][$this_plug]['ui_location'] == 'tools' ) {
              	?>
               <fieldset class='subsection_fieldset'>
