...
<div class='full_width_wrapper'>
			...
			<fieldset class='subsection_fieldset'>
    			...
    			<p class='green' style='font-weight: bold;'>Per-Token (<?=strtoupper($ct['conf']['currency']['bitcoin_primary_currency_pair'])?>): <?=$ct['opt_conf']['conversion_currency_symbols'][ $ct['conf']['currency']['bitcoin_primary_currency_pair'] ]?><span id='target_prim_currency'>0.00</span> (<span id='target_btc'>0.00</span> BTC) </p>
