...
<div class='max_1350px_wrapper'>
			...
			<p class='bitcoin' style='font-weight: bold;'>Chain data (block height, difficulty, etc) in this app is cached for <?=$app_config['power_user']['chainstats_cache_time']?> minute(s).</p>
