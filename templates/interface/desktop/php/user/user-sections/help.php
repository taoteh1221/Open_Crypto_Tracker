            ...
            'UPPERCASE_COIN_ABRV_HERE' => array(
                ...
                'pairing' => array(
                     	...
                     	'eth' => array(
                                  ...
                                  // GENERIC ETH PRICE, FROM MARKETCAP DATA (IF NO EXHANGE APIs AVAILABLE)
                                  // SHOULD BE COINGECKO'S API ID FOR THIS ASSET (SEE COINGECKO ASSET PAGE'S INFO SECTION) 
                                  // FALLBACK OPTION: LOWERCASE TICKER SYMBOL OF ASSET (UPDATED LESS FREQUENTLY), IF RANK
                                  // OF TOKEN IS #RELIABLY# WITHIN RANGE SET IN 'mcap_ranks_max' (POWER USER SECTION)
