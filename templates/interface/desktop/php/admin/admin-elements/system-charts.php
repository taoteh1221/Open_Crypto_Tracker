...
// For system charts, we want the first $ct_conf['power']['lite_chart_day_intervals'] value, not 'all'
$first_lite_chart = $ct_conf['power']['lite_chart_day_intervals'][0];
	...
	?>
			...
			$("#sys_stats_chart_<?=$chart_mode?> span.chart_loading").html(' &nbsp; No lite chart build / re-build found for: System Chart #<?=$chart_mode?>');
...
$("#sys_stats_chart_<?=$chart_mode?> span.chart_loading").html(' &nbsp; <img src="templates/interface/media/images/auto-preloaded/loader.gif" height="16" alt="" style="vertical-align: middle;" /> Loading <?=$first_lite_chart?> days chart for System Chart #<?=$chart_mode?>...');
...
zingchart.bind('sys_stats_chart_<?=$chart_mode?>', 'label_click', function(e){
  ...
  $("#sys_stats_chart_<?=$chart_mode?> div.chart_reload div.chart_reload_msg").html("Loading " + lite_chart_text + " chart for System Chart #<?=$chart_mode?>...");
