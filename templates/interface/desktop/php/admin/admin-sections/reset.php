...
<div class='max_1200px_wrapper'>
	...
	<input type='hidden' name='admin_hashed_nonce' value='<?=$oct_gen->admin_hashed_nonce('reset_api_key')?>' />
	...
	<input type='hidden' name='admin_hashed_nonce' value='<?=$oct_gen->admin_hashed_nonce('reset_webhook_key')?>' />
