...
// bitpanda / bitso / bitstamp / bittrex / bittrex_global / btcmarkets
// btcturk / buyucoin / cex / coinbase / coindcx / coingecko_sgd
...
$ct['conf']['gen']['chart_crypto_volume_decimals'] = 4;  // (default = 4)
...
$ct['conf']['comms']['news_feed_email_frequency'] = 2; // (default = 2)
////
...
$ct['conf']['comms']['price_alert_threshold'] = 8.75; // CAN BE 0 TO DISABLE PRICE ALERTS
////
...
$ct['conf']['comms']['price_alert_frequency_maximum'] = 1; // Can be 0, to have no limits
////
...
$ct['conf']['comms']['price_alert_block_volume_error'] = 'off'; // 'on' / 'off' 
////
...
$ct['conf']['comms']['price_alert_minimum_volume'] = 0; // (default = 0)
...
////
$ct['conf']['comms']['proxy_alert_frequency_maximum'] = 1; // Re-allow same proxy alert(s) after X HOURS (per ip/port pair, can be 0)
////
...
$ct['conf']['charts_alerts']['tracked_markets'] = array(
				...
				// 'othersymbol-4' => 'exchange4||trade_pair4||alert',
					...
					// NANA
					'nana' => 'jupiter_ag||sol||both',
					'nana-2' => 'coingecko_btc||btc||chart',
					'nana-3' => 'coingecko_eth||eth||chart',
					...
					// INTCSTOCK (Intel Corporation stock)
					'intcstock' => 'alphavantage_stock||usd||both',
...
$ct['conf']['power']['coingecko_api_batched_maximum'] = 100; // (default = 100), ADJUST WITH CARE!!!
...
$ct['conf']['power']['news_feed_batched_maximum'] = 20; // (default = 20), ADJUST WITH CARE!!!
////
...
// MINUTES to cache google font list (for admin interface). Set high, we rarely need it updated
$ct['conf']['power']['google_fonts_cache_time'] = 1440;  // (default = 1440)
...
$ct['conf']['power']['charts_backup_frequency'] = 1; 
...
$ct['conf']['power']['asset_performance_chart_defaults'] = '800||10'; // 'chart_height||menu_size' (default = '800||10')
...
// CHART HEIGHT MIN/MAX = 400/900 (increments of 100), MENU SIZE MIN/MAX (increments of 1) = 7/16
$ct['conf']['power']['asset_marketcap_chart_defaults'] = '600||10'; // 'chart_height||menu_size' (default = '600||10')
...
// ("min_price_percent_change_24hr_avg" should be the same value or higher as $ct['conf']['comms']['price_alert_threshold'] to work properly)
// Leave BLANK '' TO DISABLE. DECIMALS ARE SUPPORTED, USE NUMBERS ONLY (NO CURRENCY SYMBOLS / COMMAS, ETC)
$ct['conf']['power']['price_alert_whale_threshold'] = '1.25||9.75||12.75||25000'; // (default: '1.25||9.75||12.75||25000')	
...
$ct['conf']['power']['mining_calculators'] = array(
			...
			'pow' => array(
					...
					'btc' => array(
									...
									// dynamic-config-only.php (in main directory...so we can run a cached config)
...
$ct['conf']['assets'] = array(
                    ...
                    'NANA' => array(
                        ...
                        'name' => 'NANA Token',
                        'mcap_slug' => 'nana-token',
                        'pair' => array(

                                                    
                                    'btc' => array(
                                        'coingecko_btc' => 'nana-token',
                                                    ),

                                                    
                                    'eth' => array(
                                        'coingecko_eth' => 'nana-token',
                                                    ),
                    ...
                    'MSFTSTOCK' => array(
                        ...
                        'name' => 'Microsoft Corp',
                        'mcap_slug' => 'MSFT:NASDAQ',
                        'pair' => array(

                        
                                    'usd' => array(
                                        'alphavantage_stock' => 'MSFT',
                                                    ),
                    ...
                    'INTCSTOCK' => array(
                        ...
                        'mcap_slug' => 'INTC:NASDAQ',
                        'pair' => array(

                        
                                    'usd' => array(
                                        'alphavantage_stock' => 'INTC',
                                                    ),
