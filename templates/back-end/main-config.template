...
// Choosing 'all' will send to all properly-configured communication channels (and automatically skip any not properly setup)
$ct['conf']['proxy']['proxy_alert'] = 'email'; // 'off' (disabled) / 'all' / 'email' / 'text' / 'notifyme' / 'telegram'
...
// Choosing 'all' will send to all properly-configured communication channels, (and automatically skip any not properly setup)
$ct['conf']['charts_alerts']['price_alert'] = 'all'; // 'off' (disabled) / 'all' / 'email' / 'text' / 'notifyme' / 'telegram'
