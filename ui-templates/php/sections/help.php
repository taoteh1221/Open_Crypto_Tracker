	  ...
	  <div class="card z-depth-0 bordered">
	    ...
	    <div id="collapse_<?=$accord_var?>" class="collapse" aria-labelledby="heading_<?=$accord_var?>"
	      ...
	      <div class="card-body">
	        ...
	        You can setup charts or price alerts in your app install. Price alerts can be sent to email, mobile phone text, and amazon alexa notifications. You will be alerted when the <?=strtoupper($default_btc_primary_currency_pairing)?> price of an asset goes up or down a certain percent or more (whatever percent you choose in the settings), for specific exchange / base pairing combinations for that asset. You can even setup alerts for multiple exchanges / base pairings for the same asset.
	    <br /><br />
